...
class WindowAuthController:
    ...
    @staticmethod
    async def window_auth_cancel( callback_query: types.CallbackQuery, state: FSMContext ) -> None:
    ...
    @staticmethod
    async def init( callback_query: types.CallbackQuery, user: models.User, site: str ) -> None:
        data = {
            'site': site,
    ...
    @staticmethod
    async def save( payload: schemas.AuthSetupRequest ) -> None:
        try:
